...
# batch_no <- "batch_30"
# batch_path <- ("/lustre/scratch126/tol/teams/lawniczak/users/aw43/bioscan_processing/mbrave_batch_data/batch_30/")
# output_path <- ("/lustre/scratch126/tol/teams/lawniczak/users/aw43/bioscan_processing/mbrave_batch_data/batch_30/")
```
```{r load_libraries}
...
# GET THE SEQUENCES AND SCREEN FOR SIMILAR ONES - EXCLUDE THEM!
